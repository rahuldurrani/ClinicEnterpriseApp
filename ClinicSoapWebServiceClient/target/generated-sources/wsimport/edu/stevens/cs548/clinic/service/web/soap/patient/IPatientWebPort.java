...
public interface IPatientWebPort {
    ...
    @RequestWrapper(localName = "siteInfo", targetNamespace = "http://cs548.stevens.edu/clinic/service/web/soap", className = "edu.stevens.cs548.clinic.service.web.soap.patient.SiteInfo")
    @ResponseWrapper(localName = "siteInfoResponse", targetNamespace = "http://cs548.stevens.edu/clinic/service/web/soap", className = "edu.stevens.cs548.clinic.service.web.soap.patient.SiteInfoResponse")
     ...
     * @param arg0
     * @return
     *     returns edu.stevens.cs548.clinic.service.web.soap.patient.PatientDto
     * @throws PatientServiceExn_Exception
     */
    @WebMethod
    @WebResult(name = "patient-dto", targetNamespace = "http://cs548.stevens.edu/clinic/dto")
    @RequestWrapper(localName = "getPatient", targetNamespace = "http://cs548.stevens.edu/clinic/service/web/soap", className = "edu.stevens.cs548.clinic.service.web.soap.patient.GetPatient")
    @ResponseWrapper(localName = "getPatientResponse", targetNamespace = "http://cs548.stevens.edu/clinic/service/web/soap", className = "edu.stevens.cs548.clinic.service.web.soap.patient.GetPatientResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "addPatient", targetNamespace = "http://cs548.stevens.edu/clinic/service/web/soap", className = "edu.stevens.cs548.clinic.service.web.soap.patient.AddPatient")
    @ResponseWrapper(localName = "addPatientResponse", targetNamespace = "http://cs548.stevens.edu/clinic/service/web/soap", className = "edu.stevens.cs548.clinic.service.web.soap.patient.AddPatientResponse")
    ...
    @WebMethod
    @WebResult(name = "patient-dto", targetNamespace = "http://cs548.stevens.edu/clinic/dto")
    @RequestWrapper(localName = "getPatientByPatId", targetNamespace = "http://cs548.stevens.edu/clinic/service/web/soap", className = "edu.stevens.cs548.clinic.service.web.soap.patient.GetPatientByPatId")
    @ResponseWrapper(localName = "getPatientByPatIdResponse", targetNamespace = "http://cs548.stevens.edu/clinic/service/web/soap", className = "edu.stevens.cs548.clinic.service.web.soap.patient.GetPatientByPatIdResponse")
     ...
     * @param arg0
     * @return
     *     returns edu.stevens.cs548.clinic.service.web.soap.patient.TreatmentDto
     * @throws PatientServiceExn_Exception
    ...
    @RequestWrapper(localName = "patientGetTreatment", targetNamespace = "http://cs548.stevens.edu/clinic/service/web/soap", className = "edu.stevens.cs548.clinic.service.web.soap.patient.PatientGetTreatment")
    @ResponseWrapper(localName = "patientGetTreatmentResponse", targetNamespace = "http://cs548.stevens.edu/clinic/service/web/soap", className = "edu.stevens.cs548.clinic.service.web.soap.patient.PatientGetTreatmentResponse")
